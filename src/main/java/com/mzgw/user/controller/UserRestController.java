...
public class UserRestController {
   ...
   @RequestMapping(value = "/getPicture", produces = "text/plain;charset=utf-8")
  	public ResponseEntity<byte[]> getPicture(String id) throws Exception {
  		...
  		String picture = empService.getEmp(id).getPhoto();

  		InputStream in = null;
  		ResponseEntity<byte[]> entity = null;
  		String imgPath = this.userImgPath;
  	...
  	@RequestMapping(value = "/getPictureEmplNo", produces = "text/plain;charset=utf-8")
  	public ResponseEntity<byte[]> getPictureEmpl(String empl_no) throws Exception {
  		
  		String picture = empService.getEmpByEmplNo(empl_no).getPhoto();
