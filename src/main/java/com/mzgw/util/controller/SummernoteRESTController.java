package com.mzgw.util.controller;
...
public class SummernoteRESTController {
	...
	public ResponseEntity<String> uploadImg(MultipartFile file, HttpServletRequest request){
		...
		try {
			...
			result = new ResponseEntity<String>(request.getContextPath()+"/summernote/getImg?fileName="+fileName,HttpStatus.OK);
		}catch (IOException e) {
	...
	@RequestMapping(value = "/getImg",produces = "text/plain;charset=utf-8")
