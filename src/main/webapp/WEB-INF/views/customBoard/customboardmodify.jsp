...
<body>
			...
			<div class="container flex">
				...
				<div class="content">
					...
					<div class="txt-sear-box flex ju-sp-bt al-it-ce">
						<div>
							<h1 onclick="location.href='<%=request.getContextPath() %>/customBoard/${cboard.boardtype_no}';" style="cursor:pointer;">${boardName}<span>1메인메뉴 <i class="fa-solid fa-angle-right"></i>
									2서브메뉴
								</span>
							</h1>
						</div>
							...
							<div class="w-sec">
								<table>
									...
									<tbody>
										<tr>
											<th>제목</th>
											<td><input type="text" id="title" name="board_title" placeholder="제목을 쓰세요." 
												value="${cboard.board_title }"></td>
										</tr>
										<tr>
											<th>작성자</th>
											...
											<input type="hidden" name="boardtype_no" value="${cboard.boardtype_no }">
											</td>
										</tr>
										<tr>
											<th>구분</th>
								...
								<div class="editor">
									<textarea id="summernote" name="board_cont">${cboard.board_cont }</textarea>
								</div>
	...
	$('#summernote').summernote({
	 ...
	 function modify_go(){
		 ...
		 form.action = "<%=request.getContextPath()%>/customBoard/modify";
