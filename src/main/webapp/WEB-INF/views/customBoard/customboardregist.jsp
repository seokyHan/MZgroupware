...
<body>
			...
			<div class="container flex">
				...
				<div class="content">
					...
					<div class="txt-sear-box flex ju-sp-bt al-it-ce">
						 <h1 onclick="location.href='<%=request.getContextPath() %>/customBoard/${btno }';" style="cursor:pointer;">${boardName }<span>메인 <i class="fa-solid fa-angle-right"></i>게시판목록</span></h1>
					</div>
					...
					<div class="page-btn flex ju-sp-ce">
						...
						<button  type="button" class="regist" onclick="regist_go();">작성하기</button>
					</div>
				</div>
			</div>
		</div>
	...
	<script>
		...
		function regist_go(){
			...
			form.action = "<%=request.getContextPath()%>/customBoard/regist/${btno}";
		    form.submit();
		}
