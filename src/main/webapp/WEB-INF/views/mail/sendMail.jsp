        ...
        <div class="container flex">
            ...
            <div class="content">
                <div class="txt-sear-box flex ju-sp-bt al-it-ce">
                    <h1>보낸메일함 <span>메일 <i class="fa-solid fa-angle-right"></i> 보낸메일함</span></h1> 
                    ...
                    <div class="mail-wrap">
                        <div class="mail-caption flex ju-sp-bt al-it-ce">
                            <ul class="flex al-it-ce">
                                ...
                                <li>
                                    <!-- <button id="modifyUp"><i class="fa-solid fa-inbox"></i>임시보관함</button> -->
                            ...
                            <table>
			                    ...
			                    <c:if test="${empty sendMailList }" >
									<tr>
                               	  ...
                               	  <c:forEach items="${sendMailList }" var="smail">
	                                    <tr id="num">
	                                        <td><input type="checkbox" name="chk" id="check-mark" value="${smail.emailNo }"></td>
	                                        
	                                        <c:choose>
		                                        <c:when test="${smail.unityNo eq -1}">
	                                         ...
	                                         <c:choose>
		                                        <c:when test="${smail.emailSttus eq 0}">
	                                        ...
	                                        <td>[보낸사람 : ${smail.ncnm}]</td>
	                                        <td>${smail.sendEmpMail }</td>
	                                        <td class="o-title" onClick="detail_go(${smail.emailNo})"><div>${smail.emailSj }</div></td>
	                                        <td>${smail.writngOn }</td>
	                                        <td>${smail.mailSize }</td>
	                                    </tr>
	                               </c:forEach>
                                </tbody>
                            </table>
