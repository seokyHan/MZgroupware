                                                    ...
                                                    <div class="re-detail">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                ...
                                                                평가기한 :
                                                                <input type="date" name="evlStartDate" class="evlDate"> ~ <input type="date" name="evlEndDate" class="evlDate"> 
                                                            </li>
                                                            ...
                                                            <li>
                                                                <i class="fa-solid fa-calendar-days"></i>
                                                                합의기한 :
                                                                <input type="date" name="agrStartDate" class="evlDate"> ~ <input type="date" name="agrEndDate" class="evlDate">
                                                            </li>
