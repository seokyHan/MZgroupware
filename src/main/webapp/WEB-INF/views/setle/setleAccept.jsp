        ...
        <div class="top-bar flex ju-sp-bt al-it-ce">
            ...
            <div class="content">
                    ...
                    <div class="report-box">
                        ...
                        <c:forEach var="setle" items="${recentSetleList}" varStatus="status">    
                            <li>
                                <div class="date">
                                    <span><fmt:formatDate value="${setle.writngOn }"
												pattern="yyyy" /></span>
                                    <div class="to-date"><fmt:formatDate value="${setle.writngOn }"
												pattern="MM/dd(E)" /></div>
                                </div>
                                <div class="re-txt">
                                   <table>
                                    <colgroup>
                                       ...
                                       <tbody>
                                           <tr>
                                               <td colspan="2"><h3>${setle.setleForm.formCn }</h3></td>
                                           </tr>

                                           <tr>
                                                <td class="d-font">부서</td>
                                                <td>${setle.writerDepart }</td>
                                            </tr>

                                            <tr>
                                                <td class="d-font">결재현황</td>
                                                <td><c:choose>
                                ...
                                <div class="send-btn" onclick='location.href="<%=request.getContextPath()%>/setle/setleDetail?setleNo=${setle.setleNo }"'>합의하기</div>
                            </li>
						</c:forEach>
