                ...
                <div class="modal-con modal29">
                    <div class="file-modal">
                        <div class="filebox">
                            ...
                            <input type="hidden" name="unityatchmnflno" value="${d_unityatchmnflno}">
                            <input type="hidden" name="d_title" value="${d_title}">
                            <input type="hidden" name="d_writer" value="${d_writer}">
...
<div id="modal" class="modal-wrap"></div>
        <div class="modal-con modal28">
            ...
            <div class="content">
                    <div class="txt-sear-box flex ju-sp-bt al-it-ce">
                        <h1>${d_title }<span>1메인메뉴 <i class="fa-solid fa-angle-right"></i> 2서브메뉴</span></h1> 
                    ...
                    <div>
                        ...
                        <ul class="flex">
                                ...
                                <c:if test="${d_writer eq loginEmp.ncnm }">
                        ...
                        <div class="file-list">
                            <div class="arch-info">
                                <div class="caption n-caption flex ju-sp-bt">
                                   ...
                                   <div class="file-btn">
                                        <button class="regist">
                                            <a href="javascript:openModal('modal29');" class="button modal-open">
			                ...
			                <input type="hidden" name="unityatchmnflno" id="uniflno" value="${d_unityatchmnflno }">                                    	
       ...
       <form id="jobForm">
		...
		<input type="hidden" name="d_unityatchmnflno" value="${d_unityatchmnflno }">
		<input type="hidden" name="d_title" value="${d_title }">
...
for(let i=0; i<fileType.length; i++){
	...
	if(fileType[i].value == "JPG" || fileType[i].value == "PNG" || fileType[i].value == "JFIF"){
		...
		newSpan.setAttribute("onclick","javascript:openModal('modal28');");
	...
	memberPictureThumb[i].addEventListener('click', function(e){
		...
		$.ajax({
			...
			success : function(result){
					$('.modal28').html("<img src=<%=request.getContextPath()%>/pds/getPicture?ano="+result.ano+"&unityatchmnflno="+result.unityatchmnflno+">");
			},
...
const folderUnity = "${d_unityatchmnflno}";
...
form.action = "<%=request.getContextPath()%>/pds/addFilesForD";
    form.submit();
}
