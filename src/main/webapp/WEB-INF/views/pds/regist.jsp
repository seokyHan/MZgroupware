    ...
    <%@ include file="/WEB-INF/include/topbar.jsp" %>
           ...
           <div class="content">
                    <div class="txt-sear-box flex ju-sp-bt al-it-ce">
                        <div><h1>생성하기<span>1메인메뉴 <i class="fa-solid fa-angle-right"></i> 2서브메뉴</span></h1></div> 
                    
	                    
	                    <div class="flex ju-sp-ce">
	                        <button type="button" onclick="goBack();" class="back"><i class="fa-solid fa-rotate-left"></i>뒤로가기</button>
	                        <button class="regist" type="button" onclick="regist_go();"><i class="fa-solid fa-floppy-disk"></i>생성하기</button>
	                    </div>
                    </div>
                    ...
                    <div class="archive-regite">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="public">
                                                <li>
                                                    <span><i class="fa-solid fa-unlock-keyhole"></i>전사자료실</span> 
                                                    <input type="checkbox" data-toggle="checkbox" name="range1" value="pds_public">
                                                </li>
                                                <li>
                                                    <span><i class="fa-solid fa-building-user"></i>부서자료실</span> 
                                                    <input type="checkbox" data-toggle="checkbox" name="range2" value="pds_dep">
                                                </li>
                                                <li>
                                                    <span><i class="fa-solid fa-user-lock"></i>개인자료실</span> 
                                                </li>
                        ...
                        <div class="archive-upload">
                            <div class="arc-upbox">
                                <div class="m-file">
                                    <div class="center">
                                    	<div class="pdsBrowImg">
	                                        <div><img src="<%=request.getContextPath() %>/resources/images/ac_upload.png"></div>
    	...
    	// 첨부파일 개수 확인
          ...
          for (var i = 0; i < Math.min(curFileCnt, remainFileCnt); i++) {
             ...
             /*  if (validation(file)) { */
                  ...
                  htmlData += '<button type="button" onclick="deleteFileNow(' + fileNo + ');">CANCEL</button>';
                  htmlData += '</div>';
                
                  htmlData += '<div class="file-size">'+ bytesToSize(file.size) ;
                  htmlData += '<em class="numForLoading">'  + '</em>';
                  htmlData += '</div>';
                  htmlData += '</div>'; 	 
                  htmlData += '</div>'; 
                  htmlData += '</div>'; 
      ...
      if (m == 0) {
          m = 1;
          const elem = document.querySelectorAll("roding-bar");
          const numForLoading = document.querySelectorAll("numForLoading");
          for(let i=0; i< elem.length; i++){
	          ...
	          function frame() {
	            if (width >= 100) {
	              ...
	              numForLoading[i].style.width = "%" + width + "upload" ;
	            }
	          }
          }
        }
