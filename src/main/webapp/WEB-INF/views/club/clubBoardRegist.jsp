...
<body>
			...
			<div class="container flex">
				...
				<div class="content">
					...
					<div class="txt-sear-box flex ju-sp-bt al-it-ce">
						<h1
							onclick="location.href='<%=request.getContextPath() %>/club/${club_no }';"
							style="cursor: pointer;">자유게시판<span>메인 <i
								class="fa-solid fa-angle-right"></i>게시판목록
							</span>
						</h1>
						
						<div class="flex ju-sp-ce">
							<button type="button" class="back"><i class="fa-solid fa-rotate-left"></i>뒤로가기</button>
							<button type="button" class="regist" onclick="regist_go();"><i class="fa-solid fa-floppy-disk"></i>작성하기</button>
						</div>
					</div>
							...
							<div class="w-sec">
								<table>
									...
									<tbody>
										<tr>
											<th>제목</th>
											<td><input type="text" id="title" name="clubboard_title"
												placeholder="제목을 쓰세요." autocomplete="off"></td>
										</tr>
										<tr>
											<th>작성자</th>
											<td class="name">${loginEmp.ncnm }<input type="hidden"
												name="clubboard_writer" value="${loginEmp.empl_no }">
											</td>
										</tr>
										<tr>
											<th>구분</th>
														...
														<div class="mail-fileList" style="width: 100%">
															<div class="mail-fbtn flex">
																<div class="m-file mb-10">
																	<label for="fileUploadRoot"><i
																		class="fa-solid fa-computer"></i> 내 PC</label> <input
					...
					<input type="hidden" value="${clubboardtype_no }" name="clubboardtype_no"/>
	...
	<script>
		...
		function regist_go(){
			...
			form.action = "<%=request.getContextPath()%>/club/regist/${club_no}";
		    form.submit();
		}
