	...
	<div class="wrap">
			...
			<form method="POST" enctype="multipart/form-data" id="registForm">
					<div class="txt-sear-box flex ju-sp-bt al-it-ce">
						<h1 onclick="location.href='<%=request.getContextPath() %>/club/${club_no }';">
						...
						<div class="flex ju-sp-ce">
							...
							<button type="submit" class="regist" onclick="regist_go();"><i class="fa-solid fa-floppy-disk"></i>작성하기</button>
						</div>
					</div>
					...
					<div class="page-btn flex ju-sp-ce">
						...
						<button type="submit" class="regist" onclick="regist_go();">작성하기</button>
					</div>
